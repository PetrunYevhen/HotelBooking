...
namespace Facilities.Infrastructure.Configurations.DataAccess;
...
public class DataAccessModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register(c =>
        {
            var dbContextOptionBuilder = new DbContextOptionsBuilder<FacilitiesDbContext>();
            dbContextOptionBuilder.UseNpgsql(_databaseConnectionString);

            dbContextOptionBuilder
                .ReplaceService<IValueConverterSelector, StronglyTypedIdValueConverterSelector>();
            
            return new FacilitiesDbContext(dbContextOptionBuilder.Options, _loggerFactory);
        })
        .AsSelf()
        .As<DbContext>()
        .InstancePerLifetimeScope();
        
        var infrastructureAssembly = typeof(FacilitiesDbContext).Assembly;
