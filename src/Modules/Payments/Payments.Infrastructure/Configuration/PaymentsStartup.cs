...
using Payments.Infrastructure.Configuration.Gateway;
...
public class PaymentsStartup
{
       ...
       long? internalProcessingPoolingInterval = null)
   {
       ...
       ConfigureCompositionRoot(connectionString, moduleLogger, eventBus, paymentGatewaySettings);
       ...
       PaymentGatewaySettings paymentGatewaySettings)
   {
       ...
       containerBuilder.RegisterModule(new StripeGatewayModule(paymentGatewaySettings));
