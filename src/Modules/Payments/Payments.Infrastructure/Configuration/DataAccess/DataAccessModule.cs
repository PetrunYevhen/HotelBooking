...
namespace Payments.Infrastructure.Configuration.DataAccess;
...
public class DataAccessModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register(c =>
            {
                var dbContextOptionBuilder = new DbContextOptionsBuilder<PaymentsDbContext>();
                ...
                return new PaymentsDbContext(dbContextOptionBuilder.Options, _loggerFactory);
            })
            .AsSelf()
            .As<DbContext>()
            .InstancePerLifetimeScope();
